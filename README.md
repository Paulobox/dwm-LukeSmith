###### *<div align="right"><sub> </sub></div>* <br>

## [LukeSmithxyz's build](https://github.com/LukeSmithxyz/dwm) of **dwm** (FORK) (Original Keybindings)

<details><summary><h6>good to have dependencies</h6></summary>

 ```
pacman -S zathura librewolf htop ncmpcpp newsboat lf networkmanager neomutt profanity abook 
```
</details>
...
| <kbd>⊞ </kbd> + <kbd>s</kbd> | Toggle sticky |
...
| <kbd>⊞ </kbd> + <kbd>Page_Down</kbd> | Shift view right |
...
<details><summary><h2>Patches and features</h2></summary>
